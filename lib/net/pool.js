...
class Pool extends EventEmitter {
  ...
  addLoader() {
    ...
    this.logger.spam('Adding loader peer (%s).', peer.hostname());
  ...
  createOutbound(addr) {
    ...
    this.logger.spam('Connecting to %s.', peer.hostname());
  ...
  async handleClose(peer, connected) {
    ...
    if (loader) {
      this.logger.spam('Removed loader peer (%s).', peer.hostname());
      if (this.checkpoints)
        this.resetChain();
    }
